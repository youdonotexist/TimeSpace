...
[AddComponentMenu("Custom uLink/Strict Character 2D")]
[RequireComponent(typeof(uLinkNetworkView))]
public class uLinkStrictCharacter2D : uLink.MonoBehaviour
{
	...
	void uLink_OnSerializeNetworkView(uLink.BitStream stream, uLink.NetworkMessageInfo info)
	{
		...
		else
		{
			...
			Debug.Log (pos.ToString() + " " + velocity.ToString() + " " + rot.ToString());
